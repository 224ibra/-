...
BOT_NAME: process.env.BOT_NAME || "𝕿𝕺𝕶𝖄𝕺 索武",
STICKER_NAME: process.env.STICKER_NAME || "𝕿𝕺𝕶𝖄𝕺 索武",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "false",
OWNER_NUMBER: process.env.OWNER_NUMBER || "224661136877",
OWNER_NAME: process.env.OWNER_NAME || "╾⸻⟡⟡ 『𝕿𝕺𝕶𝖄𝕺 索武』 ⟡⟡⸻╼",
WELCOME: process.env.WELCOME || "true",
GOODBYE: process.env.GOODBYE || "true",
ADMIN_STATUS: process.env.ADMIN_STATUS || "false",
ALWAYS_ONLINE: process.env.ALWAYS_ONLINE || "false",
MENTION_REPLY: process.env.MENTION_REPLY || "false",
DESCRIPTION: process.env.DESCRIPTION || "*# 𝕿𝕺𝕶𝖄𝕺 𝖓’𝖆 𝖕𝖑𝖚𝖘 𝖉𝖊 𝖈œ𝖚𝖗. 𝕴𝖑 𝖆 𝖚𝖓 𝖒𝖊́𝖙𝖆𝖑 𝖍𝖆𝖇𝖎𝖑𝖑é 𝖉𝖊 𝖋𝖗𝖆𝖕𝖕𝖊𝖘. 🔨 ⎯꯭̽*",
